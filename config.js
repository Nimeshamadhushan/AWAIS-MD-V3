...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "4EBxVRCZ#BB55A-7sWFRQnL8NnOBU0H9ItezikBmTWrZTT4-WRnM",
    ...
    PACKNAME: (process.env.PACK_INFO?.split(';') || [])[1] || '94726800969',
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "94726800969",// add your bot owner number
    DEV: process.env.DEV || "94726800969", //replace with your whatsapp number
